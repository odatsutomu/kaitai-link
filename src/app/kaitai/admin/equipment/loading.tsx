// Equipment management skeleton
export default function EquipmentLoading() {
  return (
    <div className="py-6 flex flex-col gap-6 animate-pulse">
      <div className="flex items-center justify-between">
        <div className="h-7 w-24 rounded-lg" style={{ background: "#E2E8F0" }} />
        ...
        {[1,2,3,4,5,6].map(i => (
          <div key={i} className="rounded-xl p-4" style={{ background: "#fff", border: "1px solid #E5E7EB" }}>
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="h-5 w-24 rounded" style={{ background: "#E2E8F0" }} />
            </div>
            <div className="h-3 w-32 rounded mb-2" style={{ background: "#F1F5F9" }} />
