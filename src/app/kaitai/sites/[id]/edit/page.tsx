...
export default function SiteEditPage({
  ...
  if (!seed) {
    return (
      <div className="flex items-center justify-center min-h-screen" style={{ background: "#FFFFFF", color: "#94A3B8" }}>
        現場データが見つかりません
      </div>
    );
  }
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs mt-0.5 truncate max-w-[200px]" style={{ color: "#94A3B8" }}>
              {seed.name}
            </p>
          </div>
          <button
          ...
          <>
            ...
            <div>
              ...
              {!showExtend ? (
                ...
                >
                  <div className="flex items-center justify-between">
                    <p className="text-xs font-bold" style={{ color: "#EA580C" }}>工期延長</p>
            ...
            <div>
              ...
              {contractNum > 0 && (
                <>
                  ...
                  <div className="mt-1.5 flex items-center justify-between px-3 py-2 rounded-xl" style={{ background: "#F8FAFC", border: "1px solid #E2E8F0" }}>
                    <span className="text-xs" style={{ color: "#64748B" }}>税込金額</span>
                    <span className="text-sm font-bold" style={{ color: "#1E293B" }}>¥{(contractNum + taxAmount).toLocaleString()}</span>
                  </div>
                </>
              )}
            </div>
              ...
              <div className="flex flex-col gap-2">
                {[
                  ...
                  <div key={label} className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-xl flex-shrink-0 flex items-center justify-center text-sm" style={{ background: "#FFF7ED" }}>
                      {icon}
                    </div>
            ...
            {contractNum > 0 && (
              <div className="rounded-2xl p-4" style={{ background: "#F8FAFC", border: "1px solid #E2E8F0" }}>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-center justify-between pt-1.5 mt-0.5" style={{ borderTop: "1px solid #E2E8F0" }}>
              ...
              <div>
                ...
                <div className="flex flex-col gap-2">
                  {changeLog.map((entry, i) => (
                    <div key={i} className="rounded-xl px-3 py-2.5" style={{ background: "#FFF7ED", border: "1px solid #FED7AA" }}>
                      ...
                      <p className="text-[10px]" style={{ color: "#64748B" }}>{entry.before} → {entry.after}</p>
                      <p className="text-[10px] mt-0.5 font-medium" style={{ color: "#1E293B" }}>理由：{entry.reason}</p>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <>
              ...
              <div className="flex flex-wrap gap-2">
                {STRUCTURE_TYPES.map(({ type, icon }) => (
                  <button
                    ...
                    style={
                      structureType === type
                        ? { background: "#FFF7ED", color: "#EA580C", border: "2px solid #EA580C" }
                ...
                {(
                  ...
                  >
                    ...
                    <span className="text-[9px] px-1.5 py-0.5 rounded-full font-bold"
                      style={utils.has(util) ? { background: `${color}20`, color } : { background: "#F1F5F9", color: "#CBD5E1" }}>
            ...
            <div>
              ...
              <textarea
                ...
                style={{ background: "#F8FAFC", border: "1.5px solid #E2E8F0", color: "#1E293B", fontFamily: "inherit" }}
              />
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-2 mb-2">
                {photos.map((p, i) => (
                  <div key={i} className="aspect-square rounded-xl overflow-hidden relative flex items-center justify-center text-2xl" style={{ background: "#F1F5F9", border: "1px solid #E2E8F0" }}>
                    📷
              ...
              <button onClick={() => fileInputRef.current?.click()} className="w-full flex items-center gap-2 px-4 py-3 rounded-xl transition-all" style={{ background: "#F8FAFC", border: "1.5px dashed #E2E8F0" }}>
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs" style={{ color: "#94A3B8" }}>{pendingChange.field}を変更しました</p>
              </div>
            </div>
            <div className="rounded-2xl px-4 py-3 flex items-center gap-3" style={{ background: "#F8FAFC", border: "1px solid #E2E8F0" }}>
              <div className="flex-1 text-center">
                <p className="text-[10px] mb-0.5" style={{ color: "#94A3B8" }}>変更前</p>
                <p className="text-sm font-bold line-through" style={{ color: "#EF4444" }}>{pendingChange.before}</p>
              </div>
              <ChevronRight size={16} style={{ color: "#CBD5E1" }} />
              <div className="flex-1 text-center">
                <p className="text-[10px] mb-0.5" style={{ color: "#94A3B8" }}>変更後</p>
                <p className="text-sm font-bold" style={{ color: "#16A34A" }}>{pendingChange.after}</p>
              </div>
            </div>
            <div>
