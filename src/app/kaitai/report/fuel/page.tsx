    ...
    <div className="py-6 pb-28 md:pb-8 flex flex-col gap-5">
      ...
      <header className="flex flex-col gap-2" style={{ paddingBottom: 20, borderBottom: "1px solid #F3F4F6" }}>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <Fuel size={20} style={{ color: T.primary }} />
          </div>
          <div>
      ...
      <div className="flex flex-col gap-5">
        ...
        <div>
          ...
          <div className="flex flex-col gap-2">
            {siteEquipment.length === 0 ? (
              <p className="text-sm py-4 text-center rounded-2xl" style={{ background: "#F3F4F6", color: T.muted }}>
              ...
              siteEquipment.map(eq => (
                <button
                  ...
                  style={
                    selectedEqId === eq.id
                      ? { background: "${T.primaryLt}", border: "2px solid #B45309" }
        ...
        <div>
          ...
          <div className="relative">
            <span className="absolute left-4 top-1/2 -translate-y-1/2 text-sm font-bold" style={{ color: T.muted }}>¥</span>
            <input
              type="number"
              value={price}
        ...
        {litersNum > 0 && (
          ...
          >
            <span className="text-sm" style={{ color: T.muted }}>燃料費（自動加算）</span>
        ...
        <div>
          ...
          <textarea
            ...
            style={{ background: T.surface, border: "1.5px solid #E5E7EB", color: "#111827", fontFamily: "inherit" }}
          />
        </div>
        ...
        <button
          ...
          style={{
            background: selectedEqId && litersNum > 0
              ...
              : T.border,
            color: selectedEqId && litersNum > 0 ? T.surface : T.muted,
          }}
        >
